...

{
  ...
  # (see above) enabling ip_forward on the host machine is important for the docker container to be able to perform networking tasks (such as cloning the gitlab repo)
  # the registrationConfigFile must contain the gitlab token for registering a gitlab-runner
